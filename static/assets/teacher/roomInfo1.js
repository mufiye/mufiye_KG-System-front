...
function paging(page){
		$.ajax({
			type : "get",// 请求方式
			url : "http://127.0.0.1:5055/test2.json",// 发送请求地址
			dataType : "json",
			data : {// 发送给数据库的数据
...
/*function deleteItem(id){
	...
	html.push('<button type="button" data-dismiss="modal" class="btn btn-primary" onclick=deleteBachelorGuide('+id+')>确认</button>');
