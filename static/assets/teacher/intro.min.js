(function (v, n) {
    "object" === typeof exports ? n(exports) : "function" === typeof define && define.amd ? define(["exports"], n) : n(v)
})(this, function (v) {
    function n(a) {
    ...
    function F(a) {
        ...
        if (this._options.steps) for (var d = [], e = 0, d = this._options.steps.length; e < d; e++) {
            var g = x(this._options.steps[e]);
            g.step = b.length + 1;
            "string" === typeof g.element && (g.element = document.querySelector(g.element));
            if ("undefined" === typeof g.element || null == g.element) {
            ...
            e = k = 0;
            for (g = d.length; e < g; e++) if (h = d[e], null == h.getAttribute("data-step")) {
        ...
        c._introItems = b;
        G.call(c, a) && (y.call(c), a.querySelector(".introjs-skipbutton"), a.querySelector(".introjs-nextbutton"), c._onKeyDown = function (b) {
            if (27 === b.keyCode && !0 == c._options.exitOnEsc) z.call(c, a), void 0 != c._introExitCallback &&
            c._introExitCallback.call(c); else if (37 === b.keyCode) B.call(c); else if (39 === b.keyCode || 13 === b.keyCode) y.call(c), b.preventDefault ? b.preventDefault() : b.returnValue = !1
        }, c._onResize = function (a) {
            s.call(c, document.querySelector(".introjs-helperLayer"));
            s.call(c, document.querySelector(".introjs-tooltipReferenceLayer"))
        }, window.addEventListener ? (this._options.keyboardNavigation && window.addEventListener("keydown", c._onKeyDown, !0), window.addEventListener("resize", c._onResize, !0)) : document.attachEvent && (this._options.keyboardNavigation &&
    ...
    function y() {
        ...
        if (this._introItems.length <= this._currentStep) "function" === typeof this._introCompleteCallback && this._introCompleteCallback.call(this), z.call(this, this._targetElement);
        else {
    ...
    function z(a) {
        ...
        if (null != b) {
            ...
            if ((a = document.querySelectorAll(".introjs-fixParent")) &&
                0 < a.length) for (c = a.length - 1; 0 <= c; c--) a[c].className = a[c].className.replace(/introjs-fixParent/g, "").replace(/^\s+|\s+$/g, "");
    ...
    function E(a, b, c, d) {
        ...
        "undefined" != typeof d &&
        null != d && (d.style.top = null, d.style.left = null);
        if (this._introItems[this._currentStep]) {
            ...
            if (("auto" == currentTooltipPosition || "auto" == this._options.tooltipPosition) && "floating" != currentTooltipPosition) {
                var e = currentTooltipPosition, g = this._options.positionPrecedence.slice(),
                    h = C(), n = k(b).height + 10, m = k(b).width + 20, l = k(a), p = "floating";
                l.left + m > h.width || 0 > l.left + l.width / 2 - m ? (q(g, "bottom"), q(g, "top")) : (l.height + l.top + n > h.height && q(g, "bottom"), 0 > l.top - n && q(g, "top"));
                l.width + l.left + m > h.width && q(g, "right");
                0 > l.left - m && q(g, "left");
                0 < g.length && (p = g[0]);
                e && "auto" != e && -1 < g.indexOf(e) && (p = e);
                currentTooltipPosition = p
            }
            e = k(a);
            g = k(b).height;
            h = C();
            switch (currentTooltipPosition) {
                ...
                case "right":
                    b.style.left =
                        k(a).width + 20 + "px";
                    e.top + g > h.height && (c.className = "introjs-arrow left-bottom", b.style.top = "-" + (g - e.height - 20) + "px");
                    c.className = "introjs-arrow left";
                    break;
                case "left":
                    !0 == this._options.showStepNumbers && (b.style.top = "15px");
                    e.top + g > h.height ? (b.style.top = "-" + (g - e.height - 20) + "px", c.className = "introjs-arrow right-bottom") : c.className = "introjs-arrow right";
                ...
                default:
                    b.style.bottom = "-" + (k(b).height + 10) + "px",
                        b.style.left = k(a).width / 2 - k(b).width / 2 + "px", c.className = "introjs-arrow top"
            }
        }
    }
    ...
    function D(a) {
        ...
        if (null != c) {
            var e = d.querySelector(".introjs-helperNumberLayer"), g = d.querySelector(".introjs-tooltiptext"),
                h = d.querySelector(".introjs-arrow"), n = d.querySelector(".introjs-tooltip"),
                m = d.querySelector(".introjs-skipbutton"), l = d.querySelector(".introjs-prevbutton"),
                p = d.querySelector(".introjs-nextbutton");
            n.style.opacity = 0;
            n.style.display = "none";
            if (null != e) {
                var f = this._introItems[0 <= a.step - 2 ? a.step - 2 : 0];
                if (null != f && "forward" == this._direction && "floating" == f.position || "backward" == this._direction && "floating" == a.position) e.style.opacity = 0
            }
            s.call(b, c);
            s.call(b, d);
            if ((f = document.querySelectorAll(".introjs-fixParent")) && 0 < f.length) for (c = f.length - 1; 0 <= c; c--) f[c].className = f[c].className.replace(/introjs-fixParent/g,
                "").replace(/^\s+|\s+$/g, "");
            f = document.querySelector(".introjs-showElement");
            f.className = f.className.replace(/introjs-[a-zA-Z]+/g, "").replace(/^\s+|\s+$/g, "");
            ...
            var c = document.createElement("div"), m = document.createElement("div"), r = document.createElement("div"),
                t = document.createElement("div"), l = document.createElement("div"), p = document.createElement("div"),
                q = document.createElement("div");
            c.className = "introjs-helperLayer";
            m.className = "introjs-tooltipReferenceLayer";
            s.call(b, c);
            s.call(b, m);
            this._targetElement.appendChild(c);
            this._targetElement.appendChild(m);
            r.className = "introjs-arrow";
            l.className =
                "introjs-tooltiptext";
            l.innerHTML = a.intro;
            p.className = "introjs-bullets";
            !1 === this._options.showBullets && (p.style.display = "none");
            for (var v = document.createElement("ul"), c = 0, A = this._introItems.length; c < A; c++) {
                var x = document.createElement("li"), w = document.createElement("a");
                w.onclick = function () {
                    b.goToStep(this.getAttribute("data-stepnumber"))
                };
                c === a.step - 1 && (w.className = "active");
                w.href = "javascript:void(0);";
                w.innerHTML = "&nbsp;";
                w.setAttribute("data-stepnumber", this._introItems[c].step);
                x.appendChild(w);
                v.appendChild(x)
            }
            p.appendChild(v);
            q.className = "introjs-tooltipbuttons";
            !1 === this._options.showButtons && (q.style.display = "none");
            t.className = "introjs-tooltip";
            t.appendChild(l);
            t.appendChild(p);
            !0 == this._options.showStepNumbers && (f = document.createElement("span"), f.className = "introjs-helperNumberLayer", f.innerHTML = a.step, m.appendChild(f));
            t.appendChild(r);
            m.appendChild(t);
            p = document.createElement("a");
            p.onclick = function () {
                b._introItems.length - 1 != b._currentStep && y.call(b)
            };
            p.href = "javascript:void(0);";
            p.innerHTML = this._options.nextLabel;
            l = document.createElement("a");
            l.onclick = function () {
                0 != b._currentStep && B.call(b)
            };
            ...
            m.onclick = function () {
                ...
                "function" === typeof b._introExitCallback && b._introExitCallback.call(b);
                z.call(b, b._targetElement)
            };
            q.appendChild(m);
            1 < this._introItems.length && (q.appendChild(l), q.appendChild(p));
            t.appendChild(q);
            E.call(b, a.element, t, r, f)
        }
        !0 === this._options.disableInteraction && H.call(b);
        0 == this._currentStep && 1 < this._introItems.length ? (l.className = "introjs-button introjs-prevbutton introjs-disabled", p.className = "introjs-button introjs-nextbutton", m.innerHTML = this._options.skipLabel) : this._introItems.length - 1 == this._currentStep ||
        1 == this._introItems.length ? (m.innerHTML = this._options.doneLabel, l.className = "introjs-button introjs-prevbutton", p.className = "introjs-button introjs-nextbutton introjs-disabled") : (l.className = "introjs-button introjs-prevbutton", p.className = "introjs-button introjs-nextbutton", m.innerHTML = this._options.skipLabel);
        p.focus();
        a.element.className += " introjs-showElement";
        f = u(a.element, "position");
        "absolute" !== f && "relative" !== f && (a.element.className += " introjs-relativePosition");
        for (f = a.element.parentNode; null !=
        f && "body" !== f.tagName.toLowerCase();) {
            c = u(f, "z-index");
            r = parseFloat(u(f, "opacity"));
            t = u(f, "transform") || u(f, "-webkit-transform") || u(f, "-moz-transform") || u(f, "-ms-transform") || u(f, "-o-transform");
            if (/[0-9]+/.test(c) || 1 > r || "none" !== t) f.className += " introjs-fixParent";
            f = f.parentNode
        }
        I(a.element) || !0 !== this._options.scrollToElement || (r = a.element.getBoundingClientRect(), f = C().height, c = r.bottom - (r.bottom - r.top), r = r.bottom - f, 0 > c || a.element.clientHeight > f ? window.scrollBy(0, c - 30) : window.scrollBy(0, r + 100));
    ...
    function G(a) {
        ...
        b.onclick =
            function () {
                !0 == d._options.exitOnOverlayClick && (z.call(d, a), void 0 != d._introExitCallback && d._introExitCallback.call(d))
            };
        setTimeout(function () {
    ...
    A.fn = n.prototype = {
        clone: function () {
            ...
            "undefined" !==
            typeof this._introItems && y.call(this);
            return this
        }, nextStep: function () {
            y.call(this);
            return this
            ...
            s.call(this, document.querySelector(".introjs-tooltipReferenceLayer"));
            return this
