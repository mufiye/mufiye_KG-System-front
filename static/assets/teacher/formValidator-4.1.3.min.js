                ...
                if (html.length = 0) {
                    ...
                    if (elem.validatorPasswordIndex > 0 && showclass == "onCorrect") {
                        ...
                        if (level == -1 && setting.onErrorContinueChar != "") {
                            ...
                            if (level == -2 && setting.onErrorSameChar != "") {
                                showmsg = setting.onErrorSameChar
                            } else {
                                if (level == -3 && setting.onErrorCompareSame != "") {
                ...
                case"file":
                    ...
                    if (initConfig.wideWord) {
                        for (var i = 0; i < val.length; i++) {
                            len = len + ((val.charCodeAt(i) >= 19968 && val.charCodeAt(i) <= 40869) ? 2 : 1)
                        }
                    } else {
                        len = val.length
                    }
                ...
                if (c >= 48 && c <= 57) {
                    ...
                    if (c >= 97 && c <= 122) {
                        ...
                        if (c >= 65 && c <= 90) {
                            ...
                            if (specicalChars.indexOf(pwd.substr(i, 1)) >= 0) {
                                sum1[3] += 1
                            }
                        }
                    }
